...
export default function About() {
  return (
    <main className="md:h-[60vh] gap-16 md:pl-20 pl-8 pr-8 md:pr-0 flex md:flex-row flex-col md:justify-between justify-start md:items-start items-stretch overflow-hidden">
      <div className="md:h-full gap-8 flex md:w-1/2 flex-col justify-between items-start">
        ...
        <Link className="flex justify-center items-center gap-2 hover:border-b border-stone-800 text-primary-foreground" href="#">CONTACT ME <ArrowRight /></Link>
      </div>
