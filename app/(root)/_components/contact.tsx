...
import {contact, hero} from "@/lib/metadata";
  ...
  return (
    <main id="__contact" className="md:p-20 p-8 h-[70vh] flex gap-8 flex-col justify-between items-stretch">
      ...
      <div className="grid lg:grid-cols-3 lg:grid-rows-1 grid-cols-1 grid-rows-3">
        <Link href={contact.whatsapp} className="flex bg-stone-900 justify-center items-center p-10">
        ...
        <Link href={contact.instagram} className="flex bg-stone-700 justify-center items-center p-10">
      ...
      <div className="flex justify-center items-center gap-8">
        ...
        <p className="text-muted-foreground">{hero.country}</p>
      </div>
    </main>
  )
}